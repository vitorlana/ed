...
$(EXEC): src/main.cc foo.o
	$(CC) $(CFLAGS) src/main.cc foo.o -o $(EXEC)

foo.o: src/foo.cc # esse eh um exemplo, nao utilize esse tipo de nome (foo.cc, foo.h, foo.o) para seus arquivos
	$(CC) $(CFLAGS) -c src/foo.cc -o foo.o
